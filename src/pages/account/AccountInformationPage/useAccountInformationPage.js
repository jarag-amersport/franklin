...
export const useAccountInformationPage = props => {
    ...
    const [
        setCustomerEmail,
        {
            error: customerEmailUpdateError,
            loading: isUpdatingCustomerEmail,
        }
    ] = useMutation(setCustomerEmailMutation)
    ...
    const handleSubmit = useCallback(
        async ({ email, firstname, lastname, password, newPassword, allow_remote_shopping_assistance }) => {
            try {
                email = email.trim();
                ...
                allow_remote_shopping_assistance = allow_remote_shopping_assistance === true;

                if (
                    initialValues.customer.firstname !== firstname ||
                    initialValues.customer.lastname !== lastname ||
                    initialValues.customer.allow_remote_shopping_assistance !== allow_remote_shopping_assistance
                ) {
