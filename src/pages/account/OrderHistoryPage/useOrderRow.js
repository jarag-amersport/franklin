        ...
        if (data) {
            ...
            items.forEach(item => {
                ...
                if (
                    ...
                    // If specific variant cannot be found, return first, since main product does not have images assigned
                    mappedImagesData[item.product_sku] = foundVariant?.product || product.variants[0].product;
                } else {
