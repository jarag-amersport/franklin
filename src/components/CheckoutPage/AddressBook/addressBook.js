...
import { PlusCircle, AlertCircle as AlertCircleIcon } from 'react-feather';
...
const EditModal = React.lazy(() => import('../ShippingInformation/EditModal/editModal'));
        ...
        () => (
            ...
            >
                ...
                <span className={classes.addText}>
                    <FormattedMessage
                        id={'addressBook.addNewAddress.label'}
