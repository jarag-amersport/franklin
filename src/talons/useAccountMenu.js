 ...
 * @param {Boolean} props.preventRefresh - Boolean to prevent refreshing the page after logout.
...
export const useAccountMenu = props => {
  const { accountMenuIsOpen, setAccountMenuIsOpen, preventRefresh } = props;
  ...
  const handleSignOut = useCallback(async () => {
    ...
    // Clear user details' data from localStorage
    browserPersistence.removeItem('user_details');
